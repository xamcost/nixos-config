...

{
  ...
  virtualisation.oci-containers.containers."immich_server" = {
    ...
    volumes = [
      ...
      "/mnt/lethe/immich/app:/usr/src/app/upload:rw"
    ];
    ports = [ "2283:2283/tcp" ];
  ...
  virtualisation.oci-containers.containers."immich_postgres" = {
    ...
    volumes = [ "/mnt/lethe/immich/postgres:/var/lib/postgresql/data:rw" ];
    cmd = [
      "postgres"
      "-c"
  ...
  virtualisation.oci-containers.containers."immich_redis" = {
    image =
      "docker.io/valkey/valkey:8-bookworm@sha256:ff21bc0f8194dc9c105b769aeabf9585fea6a8ed649c0781caeac5cb3c247884";
    log-driver = "journald";
    extraOptions = [
